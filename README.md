...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/neptune-lightgbm-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12629&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/neptune-lightgbm-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `neptune-lightgbm` can be installed with:

```
conda install neptune-lightgbm
```

It is possible to list all of the versions of `neptune-lightgbm` available on your platform with:
